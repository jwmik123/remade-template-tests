export const Hero = () => {
  return (
    <div className="z-10 h-full w-full bg-transparent absolute flex flex-col items-center justify-center pointer-events-none">
      <div className="container">
        <h1 className="text-white font-extended uppercase text-4xl lg:text-7xl font-bold text-center">
